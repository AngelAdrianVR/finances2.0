    ...
    <AuthenticationCard>
        ...
        <form @submit.prevent="submit">
                ...
                <div class="relative">
                    ...
                    <button @click="showPassword = !showPassword" type="button" class="z-10 absolute top-2 right-2">
                        <svg v-if="!showPassword" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor" class="size-4 text-gray-500 dark:text-gray-400">
            ...
            <div class="flex justify-between mt-3 ml-2">
                <el-checkbox class="!text-gray-500 dark:!text-gray-400" v-model="form.remember" name="remember" label="Mantener sesión abierta" size="small" />
                <Link v-if="canResetPassword" :href="route('password.request')" class="underline text-sm text-primary dark:text-primary-400 hover:text-secondary dark:hover:text-primary-300 rounded-md">
            ...
            <p class="mt-12 text-center dark:text-gray-300">¿No tienes cuenta? <strong @click="$inertia.get(route('register'))" class="text-primary dark:text-primary-400 cursor-pointer hover:underline ml-2">Regístrate</strong></p>
        </form>

        <div class="mt-24 text-sm lg:flex justify-between dark:text-gray-400">
