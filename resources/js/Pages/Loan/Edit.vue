            ...
            <form @submit.prevent="update"
                ...
                <div class="flex items-center space-x-2 my-1">
                    <el-checkbox @change="handleChecked()" v-model="form.no_interest" label="Préstamo sin intereses"
                        border size="small" />
                    <el-tooltip effect="dark" content="Solo se devuelve el monto prestado" placement="top">
                ...
                <div class="flex items-center space-x-2 my-1">
                    <el-checkbox @change="handleChecked()" v-model="form.automatic" label="Gestión automatica" border
                        size="small" />
                    <el-tooltip effect="dark" placement="top">
                        <template #content>
                            <p class="text-sm">
                                El sistema registrará automáticamente los ingresos y gastos<br>
                                por intereses en cada abono, y actualizará el monto total <br>
                                de tu dinero disponible. <br>
                                Si esta opción no está activada, los abonos no afectarán tus <br>
                                ingresos, gastos ni el total de tu dinero disponible.<br>
                            </p>
                        </template>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-4 text-primary">
                ...
                <div v-if="!form.no_interest">
                    ...
                    <el-select class="!w-full" filterable v-model="form.profitability_type" placeholder="Seleccione"
                        disabled no-data-text="No hay opciones registradas"
                ...
                <div v-if="!form.no_interest">
                    ...
                    <el-select class="!w-full" filterable v-model="form.profitability_period" placeholder="Seleccione"
                        no-data-text="No hay opciones registradas" no-match-text="No se encontraron coincidencias">
                ...
                <div class="col-span-full">
                    ...
                    <el-input v-model="form.description" maxlength="255" :autosize="{ minRows: 3, maxRows: 6 }"
                ...
                <section class="px-3">
                    ...
                    <div class="my-4">
                        ...
                        <p class="font-bold ml-7">Ejemplo: <span class="font-thin">Pides $100, pero en lugar de un solo
                                pago al final, los intereses se suman y siguen creciendo. Año 1: Debes $100 + $10 (10%
                                de $100) = $110. Año 2: Ahora el 10% se calcula sobre los $110, entonces: $110 + $11
                    ...
                    <div class="my-4">
                        ...
                        <p class="font-bold ml-7">Ejemplo: <span class="font-thin">Pides $10,000 y pagas cada mes $1,000
                                Al principio, $900 son intereses y solo $100 va al capital (a la deuda). Con el tiempo,
                                pagas menos intereses y más de la deuda hasta terminar.</span></p>
                    </div>
                </section>
            </template>
...
export default {
    data() {
        const form = useForm({
            ...
            profitability_period: this.loan.profitability_period,
    ...
    methods: {
        ...
        handleChecked() {
            if (!this.form.no_interest) {
                this.form.profitability_type = 'Amortizable';
            } else {
                this.form.profitability = null;
                this.form.profitability_type = 'Sin interés';
            }
        },
        disabledDate(time) {
