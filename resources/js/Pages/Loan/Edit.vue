    ...
    <AppLayout title="Editar préstamo">
            ...
            <form @submit.prevent="update" class="rounded-xl border border-grayD9 lg:p-5 p-3 lg:w-2/3 xl:w-1/2 mx-auto mt-2 lg:grid lg:grid-cols-2 gap-3">
                ...
                <div v-if="form.type === 'Otorgado'">
                    ...
                    <el-input
                        ...
                        maxlength="50"
                        placeholder="A quien otorgaste el préstamo"
                        show-word-limit
                        type="text"
                    />
                ...
                <div class="flex items-center space-x-2 col-span-full my-1">
                    <el-checkbox @change="handleChecked()" v-model="form.no_interest" label="Préstamo sin intereses" border size="small" />
                ...
                <div v-if="!form.no_interest">
                    <div class="flex items-center justify-between ml-3 mb-1">
                        ...
                        <button @click="showProfitabilityGuideModal = true" type="button" class="rounded-sm px-3 text-sm text-[#575757] bg-grayD9">
                            Guía
                        </button>
                    </div>
                    <el-select class="!w-full" filterable v-model="form.profitability_type"
                        placeholder="Seleccione" no-data-text="No hay opciones registradas"
                        no-match-text="No se encontraron coincidencias">
        ...
        <DialogModal :show="showProfitabilityGuideModal" @close="showProfitabilityGuideModal = false">
            ...
            <template #content>
                <section class="px-3">
                    <div class="my-4">
                        <p class="font-bold mb-1">• Interés simple: <span class="font-thin">Solo pagas una vez una cantidad fija de intereses.</span></p>
                        <p class="font-bold ml-7">Ejemplo: <span class="font-thin">Pediste $100 a un amigo y acordaron que le pagarías $10 extra después de 1 año por el favor. Total a pagar: $100 + $10 = $110.</span></p>
                    </div>

                    <div class="my-4">
                        <p class="font-bold mb-1">• Interés compuesto: <span class="font-thin">Cada vez pagas más porque los intereses se calculan sobre lo que ya debías.</span></p>
                        <p class="font-bold ml-7">Ejemplo: <span class="font-thin">Pides $100, pero en lugar de un solo pago al final, los intereses se suman y siguen creciendo. Año 1: Debes $100 + $10 (10% de $100) = $110. Año 2: Ahora el 10% se calcula sobre los $110, entonces: $110 + $11 (10% de $110) = $121.</span></p>
                    </div>

                    <div class="my-4">
                        <p class="font-bold mb-1">• Interés fijo: <span class="font-thin">Se acorda en pagar la misma cantidad de intereses, sin que suba ni baje.</span></p>
                        <p class="font-bold ml-7">Ejemplo: <span class="font-thin">Pides $1,000 y cada mes pagarás $100 sin que cambie.</span></p>
                    </div>

                    <div class="my-4">
                        <p class="font-bold mb-1">• Interés amortizable: <span class="font-thin">Pagos que poco a poco cubren la deuda y los intereses.</span></p>
                        <p class="font-bold ml-7">Ejemplo: <span class="font-thin">Pides $10,000 y pagas cada mes $1,000 Al principio, $900 son intereses y solo $100 va al capital (a la deuda). Con el tiempo, pagas menos intereses y más de la deuda hasta terminar.</span></p>
                    </div>
                </section>
            </template>
