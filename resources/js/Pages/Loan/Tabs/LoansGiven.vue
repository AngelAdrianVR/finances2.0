...
<template>
    <div class="income-table-section">
        ...
        <el-table ref="tableRef" :data="loans.data" max-height="600" style="width:100%" @selection-change="handleSelectionChange" :row-class-name="tableRowClassName">
            ...
            <el-table-column prop="beneficiary_name" label="Beneficiario" min-width="140" show-overflow-tooltip />
            ...
            <el-table-column label="Monto" width="120" align="right"><template #default="{row}"><span class="amount-cell" style="color:#2F9E5B;">${{ formatMoney(row.amount) }}</span></template></el-table-column>
