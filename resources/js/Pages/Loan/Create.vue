    ...
    <AppLayout title="Registrar préstamo">
        <main class="px-3 md:px-16 py-8">
            ...
            <form @submit.prevent="store"
                ...
                <div class="flex items-center space-x-2 my-1">
                    <el-checkbox @change="handleChecked()" v-model="form.automatic" label="Gestión automatica"
                        border size="small" />
...
export default {
    data() {
        const form = useForm({
            ...
            profitability_type: 'Amortizable',
        ...
        return {
            ...
            profitabilityTypes: ['Amortizable'],
            periodicities: ['A un pago', 'Todos los días', 'Semanal', 'Quincenal', 'Mensual', 'Anual'],
            statuses: [
                {
                    label: 'En curso',
