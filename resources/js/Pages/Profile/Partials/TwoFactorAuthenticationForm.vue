            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-gray-600">
                        ...
                        <p v-else>
                            La autenticación de dos factores ya está habilitada. Escanee el siguiente código QR con la aplicación de autenticación de su teléfono o ingrese la clave de configuración.
                        </p>
                    </div>
                ...
                <div v-if="recoveryCodes.length > 0 && ! confirming">
                    <div class="mt-4 max-w-xl text-sm text-gray-600">
                        <p class="font-semibold">
                            Guarde estos códigos de recuperación en un administrador de contraseñas seguro. Pueden utilizarse para recuperar el acceso a su cuenta si pierde su dispositivo de autenticación de dos factores.
                        </p>
                    </div>

                    <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-gray-100 dark:bg-gray-800 rounded-lg dark:text-gray-200">
            ...
            <div class="mt-5">
                <div v-if="! twoFactorEnabled">
                    <ConfirmsPassword @confirmed="enableTwoFactorAuthentication">
                        <el-button type="primary" :loading="enabling" :disabled="enabling">Habilitar</el-button>
                    </ConfirmsPassword>
                </div>

                <div v-else>
                    <ConfirmsPassword @confirmed="confirmTwoFactorAuthentication">
                        <el-button v-if="confirming" type="primary" :loading="enabling" :disabled="enabling" class="me-3">Confirmar</el-button>
                    </ConfirmsPassword>

                    <ConfirmsPassword @confirmed="regenerateRecoveryCodes">
                        <el-button v-if="recoveryCodes.length > 0 && ! confirming" class="me-3">Regenerar codigos de recuperacion</el-button>
                    </ConfirmsPassword>

                    <ConfirmsPassword @confirmed="showRecoveryCodes">
                        <el-button v-if="recoveryCodes.length === 0 && ! confirming" class="me-3">Mostrar codigos de recuperacion</el-button>
                    </ConfirmsPassword>

                    <ConfirmsPassword @confirmed="disableTwoFactorAuthentication">
                        <el-button v-if="confirming" :disabled="disabling">Cancelar</el-button>
                    </ConfirmsPassword>

                    <ConfirmsPassword @confirmed="disableTwoFactorAuthentication">
                        <el-button v-if="! confirming" type="danger" :loading="disabling" :disabled="disabling">Deshabilitar</el-button>
                    </ConfirmsPassword>
                </div>
            </div>
        </template>
