...
<template>
    <div @onmouseover="hover.value = true">
        <Link @mouseenter="hovering = true" @mouseleave="hovering = false" :href="href"
            class="rounded-md px-2 py-[4px] my-1 text-xs leading-4 text-gray-300 hover:bg-white/10 hover:text-white focus:outline-none transition duration-150 ease-in-out flex justify-between items-center"
