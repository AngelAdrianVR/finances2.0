<template>
    <main class="border border-grayD9 rounded-xl p-5 text-sm">
        ...
        <div v-if="loans?.length">
            ...
            <section class="my-2 pt-2 grid grid-cols-2 gap-3 pb-2">
                <div>
            ...
            <section class="my-2 grid grid-cols-2 gap-3 border-t border-grayD9 pt-4">
                <div>
        ...
        <div v-else class="w-full flex items-center flex-wrap justify-center gap-10">
            ...
            <svg class="mx-auto" xmlns="http://www.w3.org/2000/svg" width="128" height="124" viewBox="0 0 128 124" fill="none">
                <g filter="url(#filter0_d_14133_718)">
                    <path d="M4 61.0062C4 27.7823 30.9309 1 64.0062 1C97.0319 1 124 27.7699 124 61.0062C124 75.1034 119.144 88.0734 110.993 98.3057C99.7572 112.49 82.5878 121 64.0062 121C45.3007 121 28.2304 112.428 17.0071 98.3057C8.85599 88.0734 4 75.1034 4 61.0062Z" fill="#E5F7F6" />
                </g>
                ...
                <path d="M49 20.2142C49 19.6619 49.4477 19.2142 50 19.2142H106.071C108.281 19.2142 110.071 21.0051 110.071 23.2142V25.6428H53C50.7909 25.6428 49 23.8519 49 21.6428V20.2142Z" fill="#8DBCB5" />
                <circle cx="1.07143" cy="1.07143" r="1.07143" transform="matrix(-1 0 0 1 36.1429 23.5)" fill="#296A6B" />
                <circle cx="1.07143" cy="1.07143" r="1.07143" transform="matrix(-1 0 0 1 29.7144 23.5)" fill="#296A6B" />
                <circle cx="1.07143" cy="1.07143" r="1.07143" transform="matrix(-1 0 0 1 23.2858 23.5)" fill="#296A6B" />
                ...
                <path d="M65.7893 82.4286C64.9041 82.4286 64.17 81.6945 64.17 80.7877C64.17 77.1605 58.686 77.1605 58.686 80.7877C58.686 81.6945 57.9519 82.4286 57.0451 82.4286C56.1599 82.4286 55.4258 81.6945 55.4258 80.7877C55.4258 72.8424 67.4302 72.8639 67.4302 80.7877C67.4302 81.6945 66.6961 82.4286 65.7893 82.4286Z" fill="#296A6B" />
                <path d="M79.7153 68.5462H72.9358C72.029 68.5462 71.2949 67.8121 71.2949 66.9053C71.2949 66.0201 72.029 65.286 72.9358 65.286H79.7153C80.6221 65.286 81.3562 66.0201 81.3562 66.9053C81.3562 67.8121 80.6221 68.5462 79.7153 68.5462Z" fill="#296A6B" />
                <path d="M49.9204 68.546H43.1409C42.2341 68.546 41.5 67.8119 41.5 66.9051C41.5 66.0198 42.2341 65.2858 43.1409 65.2858H49.9204C50.8056 65.2858 51.5396 66.0198 51.5396 66.9051C51.5396 67.8119 50.8056 68.546 49.9204 68.546Z" fill="#296A6B" />
                <circle cx="107.929" cy="91.0001" r="18.7143" fill="#D6F0EE" stroke="#CDE9E8" />
                <path d="M115.161 98.2322L113.152 96.2233M113.554 90.1965C113.554 86.6461 110.676 83.7679 107.125 83.7679C103.575 83.7679 100.697 86.6461 100.697 90.1965C100.697 93.7469 103.575 96.6251 107.125 96.6251C108.893 96.6251 110.495 95.9111 111.657 94.7557C112.829 93.5913 113.554 91.9786 113.554 90.1965Z" stroke="#296A6B" stroke-width="1.6" stroke-linecap="round" />
                <defs>
            ...
            <div>
                <h2 class="text-center text-black text-base font-semibold leading-relaxed pb-1">No tienes préstamos registrados o activos</h2>
                <p class="text-center text-black text-sm font-normal leading-snug pb-4">Agrega un préstamo para <br />visualizar la información </p>
                <div class="flex justify-center mt-3">
                    <button class="custom-button" @click="$inertia.get(route('loans.create'))">+ préstamo</button>
                </div>
            </div>
            </div>
        </div>
