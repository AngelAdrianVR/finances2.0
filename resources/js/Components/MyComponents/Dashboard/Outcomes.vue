<template>
    <main class="border border-grayD9 rounded-xl p-5">
        ...
        <section class="sm:grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 space-y-2 sm:space-y-0">
            <!-- Transporte -->
            <div @click="handleShowDetailOutcomes('Transporte')" class="border border-grayD9 rounded-lg p-4 cursor-pointer flex space-x-5 transition-all ease-linear duration-200 hover:scale-110">
                <div class="rounded-full size-11 flex items-center justify-center bg-[#C9E7F3]">
                    <svg width="24" height="18" viewBox="0 0 24 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.648547 14.3094C0.471389 12.4752 0.49241 11.4667 0.648547 9.6898C0.721791 8.85624 1.54247 7.41848 2.79008 6.30964C4.14215 2.02807 5.05713 0.145479 7.40964 0H16.1981C18.1592 0.357238 18.6768 0.675978 20.7049 6.30964C22.1499 7.63663 22.7611 8.33964 22.9584 9.6898C23.0801 11.4937 23.0882 12.5056 22.9584 14.3094C23.0043 15.5737 22.1697 15.9994 20.8176 15.9994H2.90275C1.26984 15.9754 0.835453 15.5753 0.648547 14.3094Z" fill="#145A85"/>
                        <path d="M1.19863 4.7322H3.00138V3.71815C3.00138 3.49281 1.76199 2.92945 1.19863 3.60548C1.01106 3.83082 0.861596 4.50685 1.19863 4.7322Z" fill="#145A85"/>
                        <path d="M20.382 4.7322V3.71815C20.382 3.38013 21.6739 3.17823 22.2974 3.60548C22.624 3.82934 22.7362 4.39267 22.2974 4.7322H20.382Z" fill="#145A85"/>
                        <path d="M4.93186 16.1261C2.79012 16.1942 1.37429 16.3258 0.875669 15.6754V17.3655C1.21369 18.1542 4.70652 18.2669 4.93186 17.3655V16.1261Z" fill="#145A85"/>
                        <path d="M22.9584 15.6754C22.4079 16.1927 21.4435 16.275 18.6779 16.1261V17.3655C18.9032 18.1542 22.6214 18.1542 22.9584 17.3655V15.6754Z" fill="#145A85"/>
                        <path d="M19.3558 9.23897C17.3134 9.89429 16.3226 10.9291 16.4263 11.4924C16.6206 12.547 19.1289 12.7318 20.1445 12.3938C21.4984 11.9431 22.2531 11.0418 22.0599 10.3657C21.7429 9.25634 20.4826 8.87748 19.3558 9.23897Z" fill="#C9E7F3"/>
                        <path d="M4.14515 9.23897C6.02251 9.66393 7.07462 10.5911 7.07462 11.4924C7.07462 12.0558 5.7014 12.9643 4.14515 12.6192C3.12897 12.3938 1.30866 11.1544 1.55369 10.3657C1.79873 9.57694 2.26779 8.81401 4.14515 9.23897Z" fill="#C9E7F3"/>
                        <path d="M14.3961 12.1685H9.77656C8.28163 12.3187 8.31091 14.4655 9.77656 14.6473H14.3961C15.8608 14.6473 15.7482 12.1685 14.3961 12.1685Z" fill="#C9E7F3"/>
                        <path d="M19.5 6.3095H3.82812C4.7295 2.36595 6.25896 0.887169 7.49835 0.999841L15.9984 1C17.3504 1 18.486 2.25328 19.5 6.3095Z" fill="#C9E7F3"/>
                    </svg>
                </div>
                <div>
            ...
            <!-- Entretenimiento -->
            <div @click="handleShowDetailOutcomes('Entretenimiento')" class="border border-grayD9 rounded-lg p-4 cursor-pointer flex space-x-5 transition-all ease-linear duration-200 hover:scale-110">
                <div class="rounded-full size-11 flex items-center justify-center bg-[#F1C9F3]">
                    <svg width="33" height="16" viewBox="0 0 33 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14.4375 10.9885H14.1451L14.0018 11.2433C12.765 13.4412 10.4113 14.9239 7.71196 14.9239C3.7289 14.9239 0.5 11.695 0.5 7.71196C0.5 3.7289 3.7289 0.5 7.71196 0.5H16.5H25.288C29.2711 0.5 32.5 3.7289 32.5 7.71196C32.5 11.695 29.2711 14.9239 25.288 14.9239C22.5887 14.9239 20.235 13.4412 18.9982 11.2433L18.8549 10.9885H18.5625H16.5H14.7065H14.4375Z" stroke="#57145A"/>
                        <path d="M26.7242 4.75258C26.7242 5.49546 26.122 6.09769 25.3791 6.09769C24.6362 6.09769 24.034 5.49546 24.034 4.75258C24.034 4.0097 24.6362 3.40747 25.3791 3.40747C26.122 3.40747 26.7242 4.0097 26.7242 4.75258Z" fill="#57145A"/>
                        <path d="M29.4144 7.4428C29.4144 8.18568 28.8122 8.78791 28.0693 8.78791C27.3264 8.78791 26.7242 8.18568 26.7242 7.4428C26.7242 6.69991 27.3264 6.09769 28.0693 6.09769C28.8122 6.09769 29.4144 6.69991 29.4144 7.4428Z" fill="#57145A"/>
                        <path d="M26.7242 10.133C26.7242 10.8759 26.122 11.4781 25.3791 11.4781C24.6362 11.4781 24.034 10.8759 24.034 10.133C24.034 9.39013 24.6362 8.78791 25.3791 8.78791C26.122 8.78791 26.7242 9.39013 26.7242 10.133Z" fill="#57145A"/>
                        <path d="M24.034 7.4428C24.034 8.18568 23.4317 8.78791 22.6889 8.78791C21.946 8.78791 21.3438 8.18568 21.3438 7.4428C21.3438 6.69991 21.946 6.09769 22.6889 6.09769C23.4317 6.09769 24.034 6.69991 24.034 7.4428Z" fill="#57145A"/>
                        <path d="M7.0822 3.40747C6.33932 3.40747 5.73709 4.0097 5.73709 4.75258V6.09769H4.39198C3.6491 6.09769 3.04688 6.69991 3.04688 7.4428C3.04688 8.18568 3.6491 8.78791 4.39198 8.78791H5.73709V10.133C5.73709 10.8759 6.33932 11.4781 7.0822 11.4781C7.82508 11.4781 8.42731 10.8759 8.42731 10.133V8.78791H9.77242C10.5153 8.78791 11.1175 8.18568 11.1175 7.4428C11.1175 6.69991 10.5153 6.09769 9.77242 6.09769H8.42731V4.75258C8.42731 4.0097 7.82508 3.40747 7.0822 3.40747Z" fill="#57145A"/>
                    </svg>
                </div>
                <div>
            ...
            <div @click="handleShowDetailOutcomes('Educación y desarrollo personal')" class="border border-grayD9 rounded-lg p-4 cursor-pointer flex space-x-5 transition-all ease-linear duration-200 hover:scale-110">
                <div class="rounded-full size-11 flex items-center justify-center bg-[#F3C9DF]">
                    <svg width="27" height="21" viewBox="0 0 27 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M24.7455 7.09687V13.7131L24.6914 13.7749C24.2226 13.8826 23.8836 14.3911 23.8838 14.8997C23.8838 15.4423 24.2481 15.8999 24.7455 16.0412C23.8501 16.4836 23.7792 17.7644 23.8838 20.5782H26.4265C26.5128 17.7469 26.4818 16.3277 25.3953 16.0412C25.8927 15.8999 26.257 15.4423 26.257 14.8997C26.257 14.3803 25.9233 13.9388 25.4586 13.778V6.77187M1 6.67851L13.2046 1L25.6634 6.67851L13.2046 12.357L1 6.67851ZM5.83097 10.5L13.2046 14.0992L20.4934 10.5V17C14.9581 20.6606 11.7557 20.752 5.83097 17V10.5Z" stroke="#851457" stroke-width="0.8"/>
                    </svg>
                </div>
                <div>
            ...
            <!-- Otros -->
            <div @click="handleShowDetailOutcomes('Otros')" class="border border-grayD9 rounded-lg p-4 cursor-pointer flex space-x-5 transition-all ease-linear duration-200 hover:scale-110">
