    ...
    <div class="h-screen hidden md:block shadow-lg relative">
        <div class="bg-[#17141D] h-full overflow-auto">
            ...
            <div class="flex items-center justify-center text-center w-full px-2 mb-7">
                <!-- Si se quiere borde agregar la r a 'borde' -->
                <button v-if="$page.props.jetstream.managesProfilePhotos"
                    ...
                    :class="{ 'border-primary': showProfileCard, 'border-transparent': !showProfileCard, 'size-12 justify-center': small, 'h-12 w-full px-2 justify-between': !small }">
